...
class TambahStock extends StatefulWidget {
  ...
  const TambahStock({super.key, required this.fetch});
                    ...
                    if (_formKey.currentState!.validate()) {
                      try {
                        var response = await ApiService().createStock(
                            ...
                            _imageInputImages);
                        print(
                            'Tambah Stock created successfully: ${response.statusCode}');
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              title: Text('Success'),
                              content:
                                  Text('Tambah Stock created successfully'),
                              actions: [
                                TextButton(
                                  onPressed: () {
                                    widget.fetch();
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              title: Text('Failed'),
                              content: Text('Tambah Stock Gagal'),
                              actions: [
                                TextButton(
                                  onPressed: () {
                                    Navigator.pop(context);
